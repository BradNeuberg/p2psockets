...
// $Id: HttpConnection.java,v 1.2 2005/01/11 08:22:44 bradneuberg Exp $
// ========================================================================
...
/** This class was modified to correctly flush its contents onto the network,
 *  which is needed by P2P Sockets.  Brad Neuberg, bkn3@columbia.edu
 */
 ...
 * @see HttpListener
 * @see HttpServer
 * @version $Id: HttpConnection.java,v 1.2 2005/01/11 08:22:44 bradneuberg Exp $
        ...
        throws IOException
    {
        ...
        else
        {
            ...
            if (!HttpFields.__Chunked.equalsIgnoreCase(transfer_coding))
            {
                ...
                {
                    String coding=(String)enumerate.nextElement();
    ...
    public boolean handleNext()
    {
        ...
        finally
        {
            ...
            {                    
                ...
                try{
                    _outputStream.close();
                    // The following line was added to force a real flush
                    // onto the network; needed for P2P Sockets
                    // Brad Neuberg, bkn3@columbia.edu
                    _outputStream.getOutputStream().flush();
